...
\TLV cpu()
   ...
   |cpu
      ...
      @1
         ...
         $is_load = $dec_bits[9:0] == 10'b000_0000011 || 
                    $dec_bits[9:0] == 10'b001_0000011 || 
                    $dec_bits[9:0] == 10'b010_0000011 || 
                    $dec_bits[9:0] == 10'b100_0000011 || 
                    $dec_bits[9:0] == 10'b101_0000011;
         ...
         $is_sub = $dec_bits[10:0] == 11'b1_000_0010011;
         $is_sll = $dec_bits[10:0] == 11'b0_001_010011;
         $is_slt = $dec_bits[10:0] == 11'b0_010_0010011;
         $is_sltu = $dec_bits[10:0] == 11'b0_011_0010011;
         $is_xor = $dec_bits[10:0] == 11'b0_100_0010011;
         $is_srl = $dec_bits[10:0] == 11'b0_101_0010011;
         $is_sra = $dec_bits[10:0] == 11'b1_101_0010011;
         $is_or = $dec_bits[10:0] == 11'b0_110_0010011;
         $is_and = $dec_bits[10:0] == 11'b0_111_0010011;
      ...
      @3
         ...
         $rf_wr_en = ($rd[4:0] != 5'b0) && $rd_valid && ($valid || >>2$valid_is_load);
         ?$rd_valid
            $rf_wr_index[4:0] = $rd[4:0];
         $rf_wr_data[31:0] = >>2$valid_is_load ? >>2$ld_data[31:0] : $result[31:0];
         ...
         $valid = !(>>1$valid_taken_br || >>2$valid_taken_br) && !(>>1$valid_is_load || >>2$valid_is_load)&& !(>>1$valid_is_jump || >>2$valid_is_jump);
      @4
         $dmem_wr_en = $is_s_instr;
         $dmem_addr[2:0] = $result[4:2];
         $dmem_wr_data[31:0] = $src2_value[31:0];
         $dmem_rd_en = $valid_is_load;
